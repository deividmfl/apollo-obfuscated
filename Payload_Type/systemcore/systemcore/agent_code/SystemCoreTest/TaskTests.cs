...
using SystemAgent;
using SystemAgent.Jobs;
using SystemAgent.Tasks;
using Microsoft.VisualStudio.TestTools.UnitTesting;

namespace SystemAgentTests
{
    [TestClass]
    public class TaskTests
    {
        ...
        public void ProcessTest()
        {
            ...
            SystemAgent.Tasks.Process.Execute(job, agent);
            // Ensure the task is marked as complete
            Assert.IsTrue(task.status == "complete");
        ...
        public void ProcessListTest()
        {
            ...
            Job job = new Job(task, null);
            SystemAgent.Tasks.ProcessList.Execute(job, null);
            // Ensure the task is marked as complete
            Assert.IsTrue(task.status == "complete");
        ...
        public void RemoveTest()
        {
            ...
            Job job = new Job(task, null);
            SystemAgent.Tasks.Remove.Execute(job, null);
            // Ensure the task is marked as complete
            Assert.IsTrue(task.status == "complete");
            // Ensure we have the correct type of output
