...
namespace SystemAgent.Management.Identity;

public class IdentityManager : IIdentityManager
{
    private IAgent _agent;

    private SystemCoreLogonInformation _userCredential;
    ...
    public bool SetIdentity(SystemCoreLogonInformation logonInfo)
    {
        bool bRet = false;
        int dwError = 0;
        IntPtr hToken = IntPtr.Zero;
    ...
    public void Revert()
    {
        ...
        _userCredential = new SystemLogonInformation();
    ...
    public bool GetCurrentLogonInformation(out SystemCoreLogonInformation logonInfo)
    {
        ...
        logonInfo = new SystemLogonInformation();
        return false;
    }
