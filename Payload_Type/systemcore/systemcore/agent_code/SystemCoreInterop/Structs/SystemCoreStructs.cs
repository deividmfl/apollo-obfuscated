...
namespace SystemAgentInterop.Structs.SystemCoreStructs
{
    ...
    public struct SystemCoreTokenInformation
    {
        public IntPtr Token;
    ...
    public struct SystemCoreLogonInformation
    {
        ...
        public SystemLogonInformation(string username, string password, string domain = ".", bool netOnly=false)
        {
