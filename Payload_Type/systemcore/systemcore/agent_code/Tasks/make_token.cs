...
namespace Tasks
{
    public class make_token : Tasking
    {
        ...
        public make_token(IAgent agent, SystemInterop.Structs.MythicStructs.MythicTask data) : base(agent, data)
        {
        }
        public override void Start()
        {
            ...
            {
                SystemCoreLogonInformation info = new SystemLogonInformation(
