...
namespace Tasks
{
    public class rm : Tasking
    {
        ...
        public rm(IAgent agent, SystemInterop.Structs.MythicStructs.MythicTask data) : base(agent, data)
        {
        }
        ...
        public override void Start()
        {
            ...
            if (SystemInterop.Utils.PathUtils.TryGetExactPath(path, out realPath))
            {
