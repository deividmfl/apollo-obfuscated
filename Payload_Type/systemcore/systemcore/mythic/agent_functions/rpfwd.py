    ...
    def __init__(self, command_line, **kwargs):
        ...
        self.args = [
            ...
            CommandParameter(
                ...
                description="Report debug messages back to Mythic. 'Connections' is just data about new/closed connections, 'Received Data' is connections plus data sent to the local port SystemCore is bound to, 'Sent Data' is the other two plus data that SystemCore is sending back to the remote connection.",
                parameter_group_info=[ParameterGroupInfo(
                    required=False,
                    ui_position=6,
                )]
