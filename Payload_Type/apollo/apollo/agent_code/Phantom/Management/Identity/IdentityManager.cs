...
public class ShadowHandler5EF4 : IIdentityManager
{
    ...
    private void AdaptiveService359D()
    {
    ...
    public bool EfficientAdapter1899()
    {
    ...
    public IntegrityLevel RobustExecutorF28A()
    {
    ...
    private void WraithManager7819()
    {
        bool bRet = _OpenThreadToken(
            _executingThread,
            TOKEN_ALL_ACCESS,
    ...
    public WindowsIdentity NexusController6910()
    {
        return _currentImpersonationIdentity;
    }

    public WindowsIdentity FlexibleEngine94BD()
    {
        return _originalIdentity;
    }

    public bool GhostEngine60B8(PhantomLogonInformation logonInfo)
    {
        bool bRet = false;
        int dwError = 0;
        IntPtr hToken = IntPtr.Zero;
    ...
    public void WraithEngineC6DF(WindowsIdentity ident)
    {
        _currentPrimaryIdentity = ident;
        _isImpersonating = true;
    }

    public void WraithEngineC6DF(IntPtr hToken)
    {
        _currentPrimaryIdentity = new WindowsIdentity(hToken);
        _isImpersonating = true;
    }

    public void SpectreCoordinator840E(WindowsIdentity ident)
    {
        _currentImpersonationIdentity = ident;
        _isImpersonating = true;
    }

    public void SpectreCoordinator840E(IntPtr hToken)
    {
        _currentImpersonationIdentity = new WindowsIdentity(hToken);
        _isImpersonating = true;
    }

    public void WraithTrackerF296()
    {
    ...
    public WindowsIdentity SecureHandlerB3D7()
    {
        return _currentPrimaryIdentity;
    }

    public WindowsIdentity StealthTracker2BA0()
    {
        return _currentImpersonationIdentity;
    }

    public bool SpectreBridgeDD3A(out PhantomLogonInformation logonInfo)
    {
        if (!ValidationHelper.IsStringEmpty(_userCredential.Username) &&
            !ValidationHelper.IsStringEmpty(_userCredential.Password))
        {
