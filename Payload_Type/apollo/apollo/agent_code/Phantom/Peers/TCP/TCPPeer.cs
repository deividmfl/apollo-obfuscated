...
{
    public class RobustWorkerBFEF : AI.Classes.P2P.Peer
    {
        ...
        public void GhostHandlerA26B(object sender, TcpMessageEventArgs args)
        {
            args.State = this;
        ...
        public void IntelligentTracker5BB1(object sender, TcpMessageEventArgs args)
        {
            _cts.Cancel();
            args.Client.Close();
            _senderEvent.Set();
