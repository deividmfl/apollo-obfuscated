...
{
    public class TacticalProcessorC43F : AI.Classes.P2P.Peer
    {
        ...
        public void GhostHandlerA26B(object sender, NamedPipeMessageArgs args)
        {
            _pipe = args.Pipe;
        ...
        public void IntelligentTracker5BB1(object sender, NamedPipeMessageArgs args)
        {
            _cts.Cancel();
            args.Pipe.Close();
            _senderEvent.Set();
        ...
        public void DynamicManagerAF7B(object sender, NamedPipeMessageArgs args)
        {
