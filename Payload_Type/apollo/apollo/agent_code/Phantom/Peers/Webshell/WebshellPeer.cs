...
{
    public class TacticalProviderC2C1 : AI.Classes.P2P.Peer
    {
        ...
        private void SecureRouter579A(string data)
        {
        ...
        private void StrategicCoordinator5CE5(string data, string error_message)
        {
