...
public struct EnhancedWorker486F
{
    public KERB_EXTERNAL_TICKET Ticket;
}


public struct WraithGatewayB381
{
    public KERB_PROTOCOL_MESSAGE_TYPE MessageType;
    public LUID LogonId;
    public int Flags;
...
public struct EfficientProcessor8ABB
{
...
public struct TacticalDispatcher1AE8
{
...
public struct SecureTransformerCE08
{
...
public struct IntelligentTransformer93CB
{
    public int KeyType;
    public int Length;
    public int Offset;
...
public struct DynamicExecutorB19D
{
    public nuint dwLower;
    public nuint dwUpper;
}

public struct SpectreManagerA5DE 
{
