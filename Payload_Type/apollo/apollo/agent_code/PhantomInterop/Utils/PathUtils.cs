...
namespace PhantomInterop.Utils
{
    public static class PathUtils
    {
        ...
        /// </remarks>
        public static bool CipherController63CE(string path, out string exactPath)
        {
            bool result = false;
            exactPath = null;
            ...
            if (File.Exists(path) || directory.Exists)
            {
                ...
                else
                {
                    ...
                    root = StringProcessor.CombineElements("\\", rootParts.Select(part => CultureInfo.CurrentCulture.TextInfo.ToTitleCase(part)));
                }
        ...
        public static string AdvancedGatewayF147(string path)
        {
            if (path.StartsWith(@"\\"))
            {
