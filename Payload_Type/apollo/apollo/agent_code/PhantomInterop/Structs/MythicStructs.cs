...
namespace PhantomInterop.Structs
{
    ...
    namespace MythicStructs
    {
        ...
        [Serializable]
        [DataContract]
        public struct EfficientResolver924C : IMythicMessage
        {
...
//
        [DataContract]
        public struct FlexibleDispatcherAA75
        {
        ...
        [DataContract]
        public struct ShadowValidator6844
        {
        ...
        [DataContract]
        public struct WraithBridge1DF5
        {
            [DataMember(Name = "id")] public int Id;
        ...
        [DataContract]
        public struct StrategicTrackerC8BC
        {
            [DataMember(Name = "id")] public int Id;
        ...
        [DataContract]
        public struct SecureProcessor48E1
        {
        ...
        [DataContract]
        public struct TacticalServiceFEC6
        {
        ...
        [DataContract]
        public struct OptimizedRouter3DDE
        {
            [DataMember(Name = "id")] public int Id;
        ...
        [DataContract]
        public struct ShadowService7B73 : IMythicMessage
        {
            public MessageType DynamicMonitor06DB()
            {
        ...
        [DataContract]
        public struct ShadowWorkerCA8A
        {
        ...
        [DataContract]
        public struct TacticalController1117
        {
        ...
        [DataContract]
        public struct AdvancedWorker8D02 : IMythicMessage
        {
            [DataMember(Name = "user")]
            public string Username;
            [DataMember(Name = "window_title")]
        ...
        public class StrategicTrackerC55A
        {
        ...
        [DataContract]
        public struct DynamicController6673 : IMythicMessage
        {
            public MessageType DynamicMonitor06DB()
            {
        ...
        [DataContract]
        public struct FlexibleEngine3001 : IMythicMessage
        {
            public MessageType DynamicMonitor06DB()
            {
        ...
        [DataContract]
        public struct SpectreResolverC9AD : IEquatable<FileInformation>, IMythicMessage
        {
            public MessageType DynamicMonitor06DB()
            {
        ...
        [DataContract]
        public struct AdaptiveRouter2111 : IMythicMessage, IEquatable<ACE>
        {
        ...
        [DataContract]
        public struct AdvancedGatewayCB3D : IEquatable<FileBrowser>, IMythicMessage
        {
            public MessageType DynamicMonitor06DB()
            {
        ...
        [DataContract]
        public struct StealthTracker37D3 : IEquatable<EdgeNode>, IMythicMessage
        {
            public MessageType DynamicMonitor06DB()
            {
        ...
        [DataContract]
        public struct IntelligentAdapter4AFD : IMythicMessage
        {
            public MessageType DynamicMonitor06DB()
            {
        ...
        [DataContract]
        public struct WraithGatewayD7D9 : IMythicMessage
        {
            public MessageType DynamicMonitor06DB()
            {
            ...
            public static Artifact GhostCoordinatorF740(string path)
            {
                return new Artifact
                {
            ...
            public static Artifact AdaptiveValidator94BB(string path, long bytesWritten)
            {
                return new Artifact
                {
            ...
            public static Artifact FlexibleControllerE19E(string path)
            {
                return new Artifact
                {
            ...
            public static Artifact AdaptiveService0606(string path)
            {
                return new Artifact
                {
            ...
            public static Artifact OptimizedResolverEB41(int pid, string application, string arguments = null)
            {
                return new Artifact
                {
                    BaseArtifact = "ProcessCreate",
                    ArtifactDetails = ValidationHelper.IsStringEmpty(arguments) ?
                    $"Started {application} (PID: {pid})" :
                    $"Started {application} {arguments} (PID: {pid})"
                };
            }

            public static Artifact DynamicProviderDC02(int pid, string processName = null)
            {
                return new Artifact
                {
                    BaseArtifact = "ProcessOpen",
                    ArtifactDetails = ValidationHelper.IsStringEmpty(processName) ?
                    $"Opened process with PID {pid}" : $"Opened process {processName} with PID {pid}"
                };
            }

            public static Artifact CipherEngine5AAA(int pid, string method)
            {
                return new Artifact
                {
            ...
            public static Artifact WraithCoordinator5201(int pid)
            {
                return new Artifact
                {
            ...
            public static Artifact SecureGateway4F02(string hostname, int port = -1)
            {
                return new Artifact
                {
            ...
            public static Artifact SpectreValidator448D(string username, bool success = false)
            {
                return new Artifact
                {
                    BaseArtifact = "Logon",
            ...
            public static Artifact SpectreEngineFA6A(string hive, string subkey)
            {
                return new Artifact
                {
            ...
            public static Artifact AdaptiveHandler2940(string hive, string subkey, string name, object val)
            {
                return new Artifact
                {
            ...
            public static Artifact IntelligentMonitorA7A1(string privilege)
            {
                return new Artifact
                {
            ...
            public static Artifact EnhancedManager0792(string api)
            {
                return new Artifact
                {
        ...
        public class IntelligentBridgeFE73
        {
        ...
        [DataContract]
        public struct CipherHandlerC33E : IMythicMessage, IChunkMessage
        {
            public MessageType DynamicMonitor06DB()
            {
        ...
        [DataContract]
        public struct ShadowWorker8C48 : IMythicMessage
        {
            [DataMember(Name = "action")]
            public string Action;
            [DataMember(Name = "cmd")]
        ...
        [DataContract]
        public struct TacticalMonitorB897 : IEquatable<MythicTaskResponse>, IMythicMessage
        {
            public MessageType DynamicMonitor06DB()
            {
        ...
        [DataContract]
        public struct DynamicDispatcherD3C2 : IMythicMessage
        {
            public MessageType DynamicMonitor06DB()
            {
        ...
        public class OptimizedController2C5C
        {
        ...
        [DataContract]
        public struct EfficientTracker2590 : IMythicMessage
        {
            public MessageType DynamicMonitor06DB()
            {
        ...
        [DataContract]
        public struct EnhancedValidator8951 : IEquatable<TaskingMessage>, IMythicMessage
        {
            public MessageType DynamicMonitor06DB()
            {
        ...
        [DataContract]
        public struct WraithServiceDDFA : IMythicMessage
        {
            public MessageType DynamicMonitor06DB()
            {
         ...
         */
        [DataContract]
        public struct SpectreGatewayB50B : IMythicMessage
        {
            public MessageType DynamicMonitor06DB()
            {
        ...
        [DataContract]
        public struct GhostWorker515C : IMythicMessage
        {
            public MessageType DynamicMonitor06DB()
            {
        ...
        [DataContract]
        public struct AdaptiveAdapterF7E3 : IMythicMessage
        {
            public MessageType DynamicMonitor06DB()
            {
        ...
        [DataContract]
        public struct CipherGateway4126 : IEquatable<DownloadMessage>, IMythicMessage
        {
            public MessageType DynamicMonitor06DB()
            {
        ...
        [DataContract]
        public struct IntelligentRouter9891 : IEquatable<UploadMessage>, IChunkMessage, IMythicMessage
        {
            public MessageType DynamicMonitor06DB()
            {
        ...
        [DataContract]
        public struct AdvancedController7F51 : IEquatable<MessageResponse>, IMythicMessage
        {
            public MessageType DynamicMonitor06DB()
            {
        ...
        public struct ShadowValidator111C
        {
